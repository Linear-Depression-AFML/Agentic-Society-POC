...
def plot_trust_evolution():
    ...
    plt.tight_layout()
    plt.savefig('ultimatum_trust_evolution.png', dpi=300, bbox_inches='tight')
    print("✓ Figure 1 saved: ultimatum_trust_evolution.png")
    plt.close()
...
def plot_offer_distribution():
    ...
    plt.tight_layout()
    plt.savefig('ultimatum_offer_distribution.png', dpi=300, bbox_inches='tight')
    print("✓ Figure 2 saved: ultimatum_offer_distribution.png")
    plt.close()
...
def plot_strategic_analysis():
    ...
    plt.tight_layout()
    plt.savefig('ultimatum_strategic_analysis.png', dpi=300, bbox_inches='tight')
    print("✓ Figure 3 saved: ultimatum_strategic_analysis.png")
    plt.close()
